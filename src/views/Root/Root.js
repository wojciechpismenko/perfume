...
const Root = () => (
  <span>
    ...
    <ul>
      ...
      <li>
        <strong>wody kwiatowe</strong> - zawierają 2-5% koncentratu zapachowego rozpuszczonego w 70-80% alkoholu etylowego 95% (spirytus).
      </li>
    </ul>
    <h2>
      Wyroby perfumeryjne bezalkoholowe
    </h2>
    <p>
      ...
      Babilonia z kolei rozwinęła sztukę perfumerii, opierając się głównie na użyciu wyciągów żywicznych ze szlachetnych drzew i krzewów, np.wyciąg oleisty z kadzidła, drzewa sandałowego oraz mirry.Technika używana przez alchemików z Babilonii to maceracja, która polegała na dokładnym potłuczeniu, zmiażdżeniu i zmieleniu żywić, zmieszaniu z olejami roślinnymi i zostawieniu tej mikstury na około 3 tygodnie.Ciepło potęgowało właściwości mikstury dając jej niezwykłą siłę regenerującą oraz odmładzającą, później następowała dokładna filtracja, czyli oddzielenie żywić od olejku.
    ...
    <ul>
      <li>
        perfumy ciekłe bezalkoholowe - 3-25% koncentratu zapachowego rozpuszczonego w takich nośnikach jak: glikol dwupropylenowy, mirystynian izopropylu, oleje roślinne lub mineralne;
      </li>
      <li>
        perfumy w kremie - 6-12% koncentratu zapachowego w emulsji kremowej typu OW lub rzadziej WO;
      </li>
      <li>
        perfumy w sztyfcie - 5-20% koncentratu zapachowego w woskach, bazach typu kredek do warg;
      </li>
      <li>
        aerozole bezalkoholowe - 5-25% koncentratu zapachowego w mieszance nośników propan - butan, dwutlenek węgla, powietrze i rozpuszczalniki bezalkoholowe;
      </li>
      <li>
        żele i emulsje odświeżające płynne lub półpłynne - 2-8% koncentratu zapachowego w bazach żelowych i emulsjach typu OW lub rzadziej WO;
      </li>
      <li>
        pudry i zasypki perfumowane - 2-8% koncentratu zapachowego w talku i innych bazach pudrowych
      </li>
    </ul>
    <h2>
    ...
    <p>
      Kompozycja zapachowa jest mieszaniną naturalnych (pochodzenia roślinnego lub zwierzęcego) ilub syntetycznych substancji zapachowych przeznaczoną do nadawania odpowiedniego zapachu różnym wyrobom i przedmiotom, a także otoczeniu człowieka. Tworzenie kompozycji zapachowych jest sztuką łączącą w sobie wiele dziedzin. Pachnidła są komponowane niczym symfonie lub piosenki i można w nich dostrzec nuty i akordy. 
    </p>
    <p>
